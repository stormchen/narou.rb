...
(function () {
        ...
        <div class="novel-card ${novel.frozen ? 'frozen' : ''}" data-id="${novel.id}">
          ...
          <div class="card-actions">
            <div class="card-actions-left">
              ...
              <button class="btn btn-sm btn-outline" data-action="convert" data-id="${novel.id}" title="轉檔為電子書">轉檔</button>
      ...
      .map((novel) => {
        ...
        <tr data-id="${novel.id}">
          ...
          <td style="text-align: right;">
            ...
            <button class="btn btn-sm btn-outline" data-action="convert" data-id="${novel.id}">轉檔</button>
  ...
  function bindNovelEvents(container) {
    ...
    container.querySelectorAll('[data-action]').forEach((btn) => {
      btn.addEventListener('click', (e) => {
        ...
        if (action === 'convert') triggerConvert(id);
  ...
  async function triggerConvert(id) {
    try {
